...
<section id="respond">
	...
	<?php else : ?>
		<form action="<?php echo site_url('/wp-comments-post.php') ?>" method="post" id="commentform">
			...
			<p><input name="submit" class="btn btn-default bg-scout-purple bg-scout-purple-link border-scout-purple border-scout-purple-link text-white" type="submit" id="submit" value="<?php _e('Submit comment', 'b4st'); ?>"></p>
