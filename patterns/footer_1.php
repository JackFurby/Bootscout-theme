...
<div class="wp-block-group alignfull has-white-color has-secondary-background-color has-text-color has-background has-link-color">
	...
	<div class="wp-block-columns alignwide">
		<!-- wp:column -->
			<div class="wp-block-column">
				<!-- wp:navigation {"overlayMenu":"never", "textColor":"white", "layout":{"type":"flex","setCascadingProperties":true,"justifyContent":"center"}} -->
				<!-- /wp:navigation -->
			</div>
			<!-- /wp:column -->
		<!-- wp:column -->
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<!-- /wp:group -->
			<!-- wp:paragraph {"layout":{"align":"center"}} -->
			<p class="has-text-align-center">Charity number: </p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		<!-- wp:column -->
		...
		<!-- wp:column -->
		<div class="wp-block-column">
			<!-- wp:paragraph {"fontSize":"smallest", "layout":{"align":"center"}} -->
