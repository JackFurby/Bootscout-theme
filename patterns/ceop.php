...
/**
 * Title: CEOP
 * Slug: bootscout-theme/ceop
 * Categories: bootscout
 * Viewport Width: 1440
 */
?>
<!-- wp:columns {"verticalAlignment":null,"backgroundColor":"scout-yellow"} -->
<div class="wp-block-columns has-scout-yellow-background-color has-background"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph {"fontSize":"x-large"} -->
...
<div class="wp-block-column is-vertically-aligned-center"  style="flex-basis:300px">
  ...
  <figure class="wp-block-image aligncenter size-full"><a href="https://www.ceop.police.uk/safety-centre/"><img src="<?php echo esc_url( get_template_directory_uri()); ?>/theme/images/CEOP.png" alt="" /></a></figure>
  <!-- /wp:image -->
</div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
