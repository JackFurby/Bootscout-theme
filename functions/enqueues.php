...
if ( ! function_exists('b4st_enqueues') ) {
	function b4st_enqueues() {
		...
		wp_register_style('bootstrap', 'https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.4.1/css/bootstrap.min.css', false, '4.4.1', null);
		wp_enqueue_style('bootstrap');
		wp_register_style('fontawesome5', 'https://use.fontawesome.com/releases/v5.12.0/css/all.css', false, '5.12.0', null);
		...
		wp_register_script('modernizr',  'https://cdnjs.cloudflare.com/ajax/libs/modernizr/3.5.0/modernizr.min.js', false, '3.5.0', true);
		wp_enqueue_script('modernizr');
		wp_enqueue_script('jquery');
		wp_register_script('bootstrap-bundle', 'https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.4.1/js/bootstrap.bundle.min.js', false, '4.4.1', true);
